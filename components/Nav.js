...
export default function Nav({show}) {
    ...
    return (
        <aside className={(show? 'left-0': '-left-full')+ ' top-0 text-gray-500 p-4 fixed w-full bg-bgGray h-screen shadow-lg md:static md:w-auto transition-all'}>
            ...
            <nav className='flex flex-col gap-2'>
                ...
                <Link href={'/items'} className={pathname.includes('/items') ? activeLink : inactiveLink}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={pathname.includes('/items') ? activeIcon : inactiveIcon}>
